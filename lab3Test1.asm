...
_lab3Test1:     file format elf32-i386
...
int main(int argc, char** argv)
{
  ...
  printf(1, "%p\n", &argc);
    1009:	8d 45 08             	lea    0x8(%ebp),%eax
    100c:	89 44 24 08          	mov    %eax,0x8(%esp)
    1010:	c7 44 24 04 51 17 00 	movl   $0x1751,0x4(%esp)
    1017:	00 
    1018:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    101f:	e8 8c 03 00 00       	call   13b0 <printf>
  exit();
    1024:	e8 29 02 00 00       	call   1252 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1349:	0f b6 92 5c 17 00 00 	movzbl 0x175c(%edx),%edx
  }while((x /= base) != 0);
    ...
    13be:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    14df:	8b 38                	mov    (%eax),%edi
          s = "(null)";
    14e1:	b8 55 17 00 00       	mov    $0x1755,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15a1:	a1 14 1a 00 00       	mov    0x1a14,%eax
{
  ...
  freep = p;
    15e9:	a3 14 1a 00 00       	mov    %eax,0x1a14
}
    15ee:	5b                   	pop    %ebx
    15ef:	5e                   	pop    %esi
    15f0:	5f                   	pop    %edi
  ...
  freep = p;
    1612:	a3 14 1a 00 00       	mov    %eax,0x1a14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    163c:	8b 1d 14 1a 00 00    	mov    0x1a14,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    167b:	3b 15 14 1a 00 00    	cmp    0x1a14,%edx
  ...
  return freep;
    16b2:	8b 15 14 1a 00 00    	mov    0x1a14,%edx
    ...
    16d4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    16d7:	89 15 14 1a 00 00    	mov    %edx,0x1a14
      return (void*)(p + 1);
    ...
    base.s.ptr = freep = prevp = &base;
    16ee:	c7 05 14 1a 00 00 18 	movl   $0x1a18,0x1a14
    16f5:	1a 00 00 
    base.s.size = 0;
    16f8:	ba 18 1a 00 00       	mov    $0x1a18,%edx
    base.s.ptr = freep = prevp = &base;
    16fd:	c7 05 18 1a 00 00 18 	movl   $0x1a18,0x1a18
    1704:	1a 00 00 
    base.s.size = 0;
    1707:	c7 05 1c 1a 00 00 00 	movl   $0x0,0x1a1c
    170e:	00 00 00 
