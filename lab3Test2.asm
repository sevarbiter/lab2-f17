...
_lab3Test2:     file format elf32-i386
...
int main(int argc, char** argv)
{
  ...
  if(argc > 1)
    100a:	ba 00 20 00 00       	mov    $0x2000,%edx
    100f:	b8 30 18 00 00       	mov    $0x1830,%eax
{
    1014:	55                   	push   %ebp
    1015:	89 e5                	mov    %esp,%ebp
    1017:	53                   	push   %ebx
    1018:	89 cb                	mov    %ecx,%ebx
    101a:	51                   	push   %ecx
    101b:	83 ec 10             	sub    $0x10,%esp
  if(argc > 1)
    101e:	83 39 01             	cmpl   $0x1,(%ecx)
    1021:	0f 4f c2             	cmovg  %edx,%eax
    size = 8192;

  char buffer[size];
    1024:	29 c4                	sub    %eax,%esp
    1026:	8d 54 24 0c          	lea    0xc(%esp),%edx
  memset(buffer, 0, size);
    102a:	89 14 24             	mov    %edx,(%esp)
    102d:	89 44 24 08          	mov    %eax,0x8(%esp)
    1031:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    1038:	00 
    1039:	e8 e2 00 00 00       	call   1120 <memset>

  printf(1, "With no kernel panic, the page unter the top of the stack was allocated.\n");
    103e:	c7 44 24 04 94 17 00 	movl   $0x1794,0x4(%esp)
    1045:	00 
    1046:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104d:	e8 9e 03 00 00       	call   13f0 <printf>
  printf(1, "%p\n", &argc);
    1052:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    1056:	c7 44 24 04 e0 17 00 	movl   $0x17e0,0x4(%esp)
    105d:	00 
    105e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1065:	e8 86 03 00 00       	call   13f0 <printf>

  exit();
    106a:	e8 23 02 00 00       	call   1292 <exit>
    106f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1389:	0f b6 92 eb 17 00 00 	movzbl 0x17eb(%edx),%edx
  }while((x /= base) != 0);
    ...
    13fe:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    151f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
    1521:	b8 e4 17 00 00       	mov    $0x17e4,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15e1:	a1 ac 1a 00 00       	mov    0x1aac,%eax
{
  ...
  freep = p;
    1629:	a3 ac 1a 00 00       	mov    %eax,0x1aac
}
    162e:	5b                   	pop    %ebx
    162f:	5e                   	pop    %esi
    1630:	5f                   	pop    %edi
  ...
  freep = p;
    1652:	a3 ac 1a 00 00       	mov    %eax,0x1aac
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    167c:	8b 1d ac 1a 00 00    	mov    0x1aac,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16bb:	3b 15 ac 1a 00 00    	cmp    0x1aac,%edx
  ...
  return freep;
    16f2:	8b 15 ac 1a 00 00    	mov    0x1aac,%edx
    ...
    1714:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    1717:	89 15 ac 1a 00 00    	mov    %edx,0x1aac
      return (void*)(p + 1);
    ...
    base.s.ptr = freep = prevp = &base;
    172e:	c7 05 ac 1a 00 00 b0 	movl   $0x1ab0,0x1aac
    1735:	1a 00 00 
    base.s.size = 0;
    1738:	ba b0 1a 00 00       	mov    $0x1ab0,%edx
    base.s.ptr = freep = prevp = &base;
    173d:	c7 05 b0 1a 00 00 b0 	movl   $0x1ab0,0x1ab0
    1744:	1a 00 00 
    base.s.size = 0;
    1747:	c7 05 b4 1a 00 00 00 	movl   $0x0,0x1ab4
    174e:	00 00 00 
